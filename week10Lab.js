...
// let myEmailForm=document.createElement('form');
...
//Answer: add values, properties, styles
...
//Answer: CSS I think. JS drives me a little crazy :)
...
myTable.style.border="2px solid purple";
...
console.log(myTable)
//Question: While this is clearly a more round-about way of making a table, how can using JavaScript in this way be more beneficial than HTML?
//Answer: I suppose if you have a table that you are constantly adding or removing from a JS table is probably more beneficial than HTML.
...
//Answer: mouse over, element hover
